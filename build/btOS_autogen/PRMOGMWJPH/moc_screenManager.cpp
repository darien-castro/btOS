...
QT_MOC_LITERAL(3, 28, 6) // "delApp"

    },
    "screenManager\0stateChanged\0\0delApp"
};
...
void screenManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->delApp(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (screenManager::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&screenManager::stateChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void screenManager::stateChanged()
{
