...
#include <memory>
#include "../../../src/applications/homeScreen/homeScreen.h"
...
QT_MOC_LITERAL(1, 11, 24), // "applicationLaunchRequest"
QT_MOC_LITERAL(2, 36, 0), // ""
QT_MOC_LITERAL(3, 37, 7) // "appName"

    },
    "homeScreen\0applicationLaunchRequest\0"
    "\0appName"
};
...
void homeScreen::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->applicationLaunchRequest((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&homeScreen::applicationLaunchRequest)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void homeScreen::applicationLaunchRequest(const QString & _t1)
{
